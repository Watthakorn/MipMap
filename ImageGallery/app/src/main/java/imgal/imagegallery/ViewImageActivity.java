...
public class ViewImageActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageview = (ImageView) findViewById(R.id.imgBig);
        ...
        ImageButton del = (ImageButton) findViewById(R.id.delbtn);
        del.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mDb.execSQL("DELETE FROM "+ DatabaseImgal.TABLE_NAME+
                    " WHERE "+DatabaseImgal.COL_ID+"="+ getIntent().getIntExtra("id",0)+";");
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ViewImageActivity.this,EditLocation.class);
